...
>
  ...
  >
    ...
    <span className="text-blue">@ {experiences[activeTab].company}</span>
  </motion.h3>
  <motion.p
  ...
  >
    {experiences[activeTab].responsibilities.map((item, i) => (
      ...
      <div className="font-kode absolute text-center w-full md:w-auto md:right-8 bottom-4 z-20 text-[0.6rem] opacity-30">
